				...
				this.$get = [
					...
					function (d, c, f, g, l, k, q, p) {
						function m(a) {
							var e = t.current;
							n = A();
							(x = !B && n && e && n.$$route === e.$$route && (!n.reloadOnUrl || (!n.reloadOnSearch && b.equals(n.pathParams, e.pathParams)))) ||
								(!e && !n) ||
						...
						function z(a) {
							...
							b.isDefined((e = a.template))
								...
								: b.isDefined((c = a.templateUrl)) &&
								  (b.isFunction(c) && (c = c(a.params)), b.isDefined(c) && ((a.loadedTemplateUrl = q.valueOf(c)), (e = k(c))));
							return e;
						}
						function A() {
							var a, e;
							...
							t = {
								...
								updateParams: function (a) {
									if (this.current && this.current.$$route)
										(a = b.extend({}, this.current.params, a)), c.path(v(this.current.$$route.originalPath, a)), c.search(a);
									else throw H('norout');
								},
							};
